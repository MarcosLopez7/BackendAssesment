...
urlpatterns = [
    ...
    url('^products/(?P<pk>\d+)/$', RetrieveProductView.as_view(), name='show-product'),
    url('^products/(?P<pk>\d+)/edit/$', EditProductView.as_view(), name='edit-product'),
